  ...
  class ExceptionDialog
    ...
    def initialize(parent, exception, title = 'COSMOS Exception', exit_afterwards = true, log_exception = true, log_file = nil)
      ...
      begin
        ...
        # Any exception between try_lock and unlock would otherwise leave
        # the mutex held forever, so dialog_open? stays true and every
        # later error dialog in the process is silently suppressed.
        @@mutex.unlock
      end
      if exit_afterwards
